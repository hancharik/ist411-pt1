...
public class MonkeyMerchant extends JButton implements Runnable, ActionListener {
  ...
  /*      
   ...
   public int numberOfTransactions(){
    ...
    public  synchronized void p2pTransaction(TownsFolk seller, TownsFolk buyer, Monkey monkee, Transaction trans) {
    ...
    public synchronized void marketSale(MonkeyMarket monkeyMarket, TownsFolk buyer, Monkey monkee, Transaction trans) {
    ...
    public synchronized void marketReturn(MonkeyMarket monkeyMarket, TownsFolk buyer, Monkey monkee, Transaction trans) {
